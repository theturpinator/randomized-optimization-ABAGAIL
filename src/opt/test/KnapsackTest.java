...
public class KnapsackTest {
    ...
    public static void main(String[] args) {
        ...
        KnapsackEvaluationFunction ef = new KnapsackEvaluationFunction(values, weights, MAX_KNAPSACK_WEIGHT, copies);
        ...
        System.out.println("value : " + ef.value(rhc.getOptimal()));
        System.out.println("============================");
        ...
        System.out.println("value : " + ef.value(ga.getOptimal()));
        System.out.println("============================");
        ef.resetFunctionEvaluationCount();
